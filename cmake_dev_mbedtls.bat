...
cmake .. -G "Visual Studio 15 2017 Win64" -DCMAKE_BUILD_TYPE=Debug -DLIBUV_ROOT=D:/atf/atsf4g-co/3rd_party/libuv/prebuilt/windows-amd64 -DMSGPACK_ROOT=C:\workspace\lib\protocol\msgpack\prebuilt -DLIBCURL_ROOT=C:\workspace\lib\network\prebuilt\win64 -DMBEDTLS_ROOT=C:\workspace\lib\crypt\prebuilt\win64 -DPROJECT_ENABLE_SAMPLE=ON -DPROJECT_ENABLE_UNITTEST=ON -DPROJECT_ENABLE_TOOLS=ON