...
set (3RD_PARTY_PROTOBUF_VERSION "3.6.1")
...
set(3RD_PARTY_PROTOBUF_FLAG_OPTIONS "-DCMAKE_C_FLAGS=${3RD_PARTY_PROTOBUF_C_FLAGS}" "-DCMAKE_CXX_FLAGS=${3RD_PARTY_PROTOBUF_CXX_FLAGS}")
...
FindConfigurePackage(
    PACKAGE Protobuf
    BUILD_WITH_CMAKE
    CMAKE_FLAGS -DCMAKE_C_COMPILER=${CMAKE_C_COMPILER} -DCMAKE_CXX_COMPILER=${CMAKE_CXX_COMPILER} -DCMAKE_POSITION_INDEPENDENT_CODE=ON
        ${3RD_PARTY_PROTOBUF_FLAG_OPTIONS} -Dprotobuf_BUILD_TESTS=OFF -Dprotobuf_BUILD_EXAMPLES=OFF -DCMAKE_CXX_STANDARD=${CMAKE_CXX_STANDARD} -DBUILD_SHARED_LIBS=${3RD_PARTY_PROTOBUF_BUILD_SHARED_LIBS}
